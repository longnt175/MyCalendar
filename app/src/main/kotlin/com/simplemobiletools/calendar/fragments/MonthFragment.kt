            ...
            (mHolder.findViewById(mRes.getIdentifier("day_$i", "id", mPackageName)) as TextView).apply {
                ...
                setOnClickListener {
                    if (!day.hasEvent)
                        ...
                        Toast.makeText(activity, "This day is full. Please choose other day", Toast.LENGTH_LONG).show()
                }
...
//                    drawable.setColorFilter(getDayDotColor(day, weakerText), PorterDuff.Mode.SCREEN)
//                    drawable
//                } else if (day.isToday) {
//                    val todayCircle = mRes.getDrawable(R.drawable.circle_empty)
//                    todayCircle.setColorFilter(weakerText, PorterDuff.Mode.SCREEN)
//                    todayCircle
//                }
//                else
                        if (day.hasEvent) {
//                            val drawable = mRes.getDrawable(R.drawable.day_background_booked).mutate()
//                            drawable.setColorFilter(getDayDotColor(day, weakerText), PorterDuff.Mode.SRC)
//                            drawable
                            val drawable = mRes.getDrawable(R.drawable.day_background_booked).mutate()
//                    drawable.setColorFilter(getDayDotColor(day, weakerText), PorterDuff.Mode.SCREEN)
                    drawable
                } else {
                            val drawable = mRes.getDrawable(R.drawable.day_background_empty).mutate()
//                    drawable.setColorFilter(getDayDotColor(day, weakerText), PorterDuff.Mode.SCREEN)
                            drawable
                }
            }
